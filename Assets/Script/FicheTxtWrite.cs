...
public class FicheTxtWrite : MonoBehaviour
{
    ...
    public void Personnage()
    {
        ...
        // Stats
        File.AppendAllText(path,
            "HP " + CanvasPV.GetComponent<FicheUI>().HP + "\n"
            + "HPMax " + CanvasPV.GetComponent<FicheUI>().HP + "\n"
        ...
        // Compétences
        File.AppendAllText(path,
            "RaceComp " + RaceComp.GetComponent<TMP_InputField>().text + "\n"
            + "Comp " + Comp.GetComponent<TMP_InputField>().text + "\n\n");
        
        // Equipement
        File.AppendAllText(path,
            "Equipement " + Equipment.GetComponent<TMP_InputField>().text + "\n");
    }
}
