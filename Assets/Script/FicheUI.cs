...
public class FicheUI : MonoBehaviour
{
    ...
    public void OnChangeValue()
    {
        ...
        HP.text = (RaceStructs[DropDownRace.GetComponent<TMP_Dropdown>().value].HpMax + (5 * RaceStructs[DropDownRace.GetComponent<TMP_Dropdown>().value].Endurance)).ToString();
    }
    ...
    private void DefRace()
    {
        ...
        RaceStructs[0].CompetenceRace = "Points de stats attribuables supplémentaires";
        ...
        RaceStructs[1].CompetenceRace = "Condition physique accrue, une main, une pince (+5 dégâts à mains nues)";
        ...
        RaceStructs[3].CompetenceRace = "Vision nocturne, Griffes (+2 Dégâts à mains nues)";
        ...
        RaceStructs[5].CompetenceRace = "Communion avec la nature, communication avec la faune";
        ...
        RaceStructs[6].CompetenceRace =
            "Respirent sous l’eau (WIP),être en contact avec l’eau (pluie, rivière, etc.) ajoute 2 points à tous les jets";
    }
}
